...
if model=="Sentiment Classifier":
    ...
    user_id = st.text_input("Enter user id", "skatsushi2025@gmail.com")
    ...
    user_id = st.text_input("Enter user id", "skatsushi@gmail.com.com")
    ...
    user_id = st.text_input("Enter user id", "skatsushi@gmail.com")
